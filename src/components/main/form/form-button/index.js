...
export const FormButtons = ({ handlePrint }) => {
  ...
  const uploadSample = () => {
    ...
    dispatch(
      setSocial([
        { _id: nanoid(), name: 'Twitter', link: 'johndoe' },
        { _id: nanoid(), name: 'Github', link: 'johndoe' },
        { _id: nanoid(), name: 'LinkedIn', link: 'johndoe' },
        { _id: nanoid(), name: 'Website', link: 'https://johndoe.dev' },
        { _id: nanoid(), name: 'URL', link: 'https://example.com' },
      ])
    );
    dispatch(
      setLanguages([
        { _id: nanoid(), name: 'Spanish', level: 'C2' },
        { _id: nanoid(), name: 'Italian', level: 'B1' },
      ])
    );
    dispatch(
      setHobbies([
        { _id: nanoid(), name: 'Swimming' },
        { _id: nanoid(), name: 'Fitness' },
        { _id: nanoid(), name: 'Chess' },
        { _id: nanoid(), name: 'Camping' },
      ])
    );
    dispatch(
      setEducation([
    ...
    dispatch(
      setSkills([
        { _id: nanoid(), name: 'HTML', level: 9 },
        { _id: nanoid(), name: 'CSS', level: 10 },
        { _id: nanoid(), name: 'JavaScript', level: 8 },
      ])
    );
    dispatch(
      setProjects([
